...
clear all
clc
%load('C:\mmm\mxf412\heatmap.mat')
a=FF;
% % heatmap(a); 
[p,r] = ranksum(a(:,1),a(1:119,16))
% boxplot(a(1:119,1),a(1:119,16));
% h = gca;
% h.XTick = [1 2];
% h.XTickLabel = {'AF-','AF+'};
% xlabel('AF recurrence')
% ylabel('Fractal dimension')
% title(['Lumen model: P-value=',num2str(p)])
[r,p]=corr(a);
% heatmap(p)
% Labels=['1','0','22','32','45','22','33','42','31','2','1','23','1','23'];
x=r;
% load heatmapData
...
snapnow; 
y = p;
heatmap(y, 1:28,1:28, '%0.2f', 'Colormap', 'money', ...
        'Colorbar', true);
%% Simple Heatmap
% Generate heatmap only with no labels
clf
heatmap(spreads_small(1:119,1:8));
clf
heatmap(spreads_small(1:119,1:5), [], [], '$%0.2f', 'Colormap', 'money', ...
