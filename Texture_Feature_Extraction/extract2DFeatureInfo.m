...
alternatecodepath = 'Z:\home\jacob\AlternateCodePath\feature_extraction'; %in case the G:/ drive decides it doesnt wanna work today
...
if ~all(cellfun('isempty',strfind(class_options,'haralick')))
 ...
 hfeatnames4 = {'Haralick entropy ws=4' 'Haralick energy ws=4' 'Haralick inertia ws=4' 'Haralick idm ws=4' 'Haralick correlation ws=4' 'Haralick info1 ws=4' ...
    'Haralick info2 ws=4' 'Haralick sum-av ws=4' 'Haralick sum-var ws=4' 'Haralick sum-ent ws=4' 'Haralick diff-av ws=4' 'Haralick diff-var ws=4' 'Haralick diff-ent ws=4'};    
...
%     end
    ...
    for ws = ws_options
        ...
        try
            ...
            addpath(genpath(alternatecodepath));
            hfeats = cat(3,hfeats,haralickfun(norm_img,nbins,ws,dist,bkgrd));
            rmpath(genpath(alternatecodepath));
        end
