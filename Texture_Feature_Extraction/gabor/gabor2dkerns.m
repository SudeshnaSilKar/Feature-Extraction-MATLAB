function [gb_c,gb_s, ws]=gabor2dkerns(theta,lambda,b,psi,gamma)
...
%optional
gb = sqrt(gb_c.^2 + gb_s.^2);
figure('color','white','units','normalized','position',[0.4 0.4 0.6 0.6]);imagesc(gb);colormap gray;
end
